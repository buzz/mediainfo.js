...
describe('file_example_MP4_640_3MG.mp4', () => {
  it('should parse file', async () => {
    ...
    expect(parseFloat(track0.Duration)).toBeCloseTo(53.76)
    expect(parseInt(track0.OverallBitRate)).toBeNear(677620, 2)
    expect(track0.FrameRate).toBe('25.000')
    ...
    expect(parseFloat(track1.Duration)).toBeCloseTo(53.76)
    expect(parseInt(track1.BitRate)).toBeNear(558000, 2)
    ...
    expect(parseFloat(track2.Duration)).toBeCloseTo(53.76)
    expect(track2.BitRate_Mode).toBe('CBR')
    expect(parseInt(track2.BitRate)).toBeNear(128041, 2)
